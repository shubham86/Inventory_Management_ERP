...
namespace JericoSmartGrocery.Reports
{
    public partial class frmSupplierList : Form
    {
        ...
        private void dgvSupplierDetails_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                frmSupplierPaymentReport frmSupplierPaymentReport = new frmSupplierPaymentReport();

                frmSupplierPaymentReport.ID = dgvSupplierDetails.SelectedRows[0].Cells[1].Value.ToString();
                frmSupplierPaymentReport.SupName = dgvSupplierDetails.SelectedRows[0].Cells[2].Value.ToString();
                frmSupplierPaymentReport.balanceAmt = Convert.ToDecimal(dgvSupplierDetails.SelectedRows[0].Cells[6].Value);
                frmSupplierPaymentReport.advanceAmt = Convert.ToDecimal(dgvSupplierDetails.SelectedRows[0].Cells[5].Value);

                Opacity = .50;
                frmSupplierPaymentReport.ShowDialog();
                LoadDatagrid();
                Opacity = 1;
