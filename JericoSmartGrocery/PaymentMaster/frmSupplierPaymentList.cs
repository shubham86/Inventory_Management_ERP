...
{
    public partial class frmSupplierPaymentList : Form
    {
        ...
        private void frmSupplierPaymentList_Load(object sender, EventArgs e)
        {
            LoadDatagrid();
        }
        ...
        private void dgvSupplierDetails_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                frmSupplierPayment.ID = dgvSupplierDetails.SelectedRows[0].Cells[1].Value.ToString();
                frmSupplierPayment.SuppName = dgvSupplierDetails.SelectedRows[0].Cells[2].Value.ToString();
                frmSupplierPayment.balanceAmt = Convert.ToDecimal(dgvSupplierDetails.SelectedRows[0].Cells[6].Value.ToString() == "" ? "0.00" : dgvSupplierDetails.SelectedRows[0].Cells[6].Value);
                frmSupplierPayment.advanceAmt = Convert.ToDecimal(dgvSupplierDetails.SelectedRows[0].Cells[5].Value.ToString() == "" ? "0.00" : dgvSupplierDetails.SelectedRows[0].Cells[5].Value);
