...
{
    public partial class frmCustomerBillReport : Form
    {
        public string billNo;
        public string salePaymentID;
        public string type;

        public frmCustomerBillReport()
        {
            InitializeComponent();
        }
        ...
        private void LoadDatagrid()
        {
            ...
            try
            {
                ...
                comm.CommandText = "Proc_Sale_FetchBillDetails";

                comm.Connection = conn;

                comm.Parameters.AddWithValue("billNo", billNo);
                comm.Parameters.AddWithValue("salePayID", salePaymentID);
                comm.Parameters.AddWithValue("payType", type);
                ...
                if (DS.Tables[1].Rows.Count > 0)
                {
                    ...
                    lblAdvance.Text = DS.Tables[1].Rows[0]["customerAdvanceAmount"].ToString();
