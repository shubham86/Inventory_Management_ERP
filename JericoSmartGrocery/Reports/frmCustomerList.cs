...
namespace JericoSmartGrocery.Reports
{
    public partial class frmCustomerList : Form
    {
        ...
        private void dgvCustomerDetails_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                frmCustomerPaymentReport frmCustomerPaymentReport = new frmCustomerPaymentReport();

                frmCustomerPaymentReport.ID = dgvCustomerDetails.SelectedRows[0].Cells[1].Value.ToString();
                frmCustomerPaymentReport.CustName = dgvCustomerDetails.SelectedRows[0].Cells[2].Value.ToString();
                frmCustomerPaymentReport.balanceAmt = Convert.ToDecimal(dgvCustomerDetails.SelectedRows[0].Cells[6].Value);
                frmCustomerPaymentReport.advanceAmt = Convert.ToDecimal(dgvCustomerDetails.SelectedRows[0].Cells[5].Value);

                Opacity = .50;
                frmCustomerPaymentReport.ShowDialog();
                LoadDatagrid();
                Opacity = 1;
