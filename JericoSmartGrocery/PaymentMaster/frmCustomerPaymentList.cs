...
{
    public partial class frmCustomerPaymentList : Form
    {
        ...
        private void dgvCustomerDetails_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                frmCustomerPayment.ID = dgvCustomerDetails.SelectedRows[0].Cells[1].Value.ToString();
                frmCustomerPayment.CustName = dgvCustomerDetails.SelectedRows[0].Cells[2].Value.ToString();
                frmCustomerPayment.balanceAmt = Convert.ToDecimal(dgvCustomerDetails.SelectedRows[0].Cells[6].Value.ToString() == "" ? "0.00" : dgvCustomerDetails.SelectedRows[0].Cells[6].Value);
                frmCustomerPayment.advanceAmt = Convert.ToDecimal(dgvCustomerDetails.SelectedRows[0].Cells[5].Value.ToString() == "" ? "0.00" : dgvCustomerDetails.SelectedRows[0].Cells[5].Value);
        ...
        private void dgvCustomerDetails_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                if (Convert.ToDecimal(dgvCustomerDetails.SelectedRows[0].Cells[5].Value.ToString() == "" ? "0.00" : dgvCustomerDetails.SelectedRows[0].Cells[5].Value) > 0)
                {
                    frmCustomerCashReturn frmCustomerCashReturn = new frmCustomerCashReturn();

                    frmCustomerCashReturn.ID = dgvCustomerDetails.SelectedRows[0].Cells[1].Value.ToString();
                    frmCustomerCashReturn.CustName = dgvCustomerDetails.SelectedRows[0].Cells[2].Value.ToString();
                    frmCustomerCashReturn.balanceAmt = Convert.ToDecimal(dgvCustomerDetails.SelectedRows[0].Cells[6].Value.ToString() == "" ? "0.00" : dgvCustomerDetails.SelectedRows[0].Cells[6].Value);
                    frmCustomerCashReturn.advanceAmt = Convert.ToDecimal(dgvCustomerDetails.SelectedRows[0].Cells[5].Value.ToString() == "" ? "0.00" : dgvCustomerDetails.SelectedRows[0].Cells[5].Value);

                    Opacity = .50;
                    frmCustomerCashReturn.ShowDialog();
                    Opacity = 1;
                    LoadDatagrid();
                }
                else
                {
                    MessageBox.Show("Advance amount is 0.00.", "Alert !", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                }
            }
        }
